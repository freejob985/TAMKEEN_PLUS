...
<!-- Student start -->
@php
$cors = App\Course::where('status', '1')->where('category_id', "18")->orderBy('id', 'desc')->take(20)->get();
@endphp
@if( ! $cors->isEmpty() )
    ...
    <div class="container">
        <h4 class="student-heading" style="background: white;padding: 10px 0px;text-align: center;margin: 50px 0px;">حمل افكارك الريادية</h4>
        <div id="my-courses-sliderd" class="student-view-slideraa-main-blockaa owl-carousel" style="margin: 50px 0px;">
            @foreach($cors as $c)
