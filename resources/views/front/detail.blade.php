        ...
        <div class="row">
            <div class="col-lg-8">
                <div class="about-home-block">
                    ...
                    <ul>
                        <li><a href="#" title="about">{{ __('frontstaticword.Created') }}: {{ $course->user['fname'] }} {{ $course->user['lname'] }} </a></li>
                        ...
                        @if($course->type == 1)
                            ...
                            @if(Auth::check())
                                ...
                                @if(Auth::User()->role == "admin")
                                    <div  style="display:none;" class="about-home-btn btm-20" style="display:none;">
                                ...
                                @else
                                    @if(isset($course->duration))
                                        ...
                                        <div style="display:none;" class="course-duration btm-10">{{ __('frontstaticword.EnrollDuration') }}: {{ $course->duration }} Months</div>
                                        @else
                                        <div style="display:none;" class="course-duration btm-10">{{ __('frontstaticword.EnrollDuration') }}: {{ $course->duration }} Days</div>
                                        @endif
                                    @endif
                                    ...
                                    @else
                                        ...
                                        @else
                                            <div class="about-home-btn btm-20" style="display:none;">
            ...
            <div class="col-lg-8">
                @if($whatlearns->isNotEmpty())
                    <div class="product-learn-block">
                        <h3 class="product-learn-heading">مادا نقدم لك؟</h2>
                        <div class="row">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-11 col-sm-11 col-11">
                                    <div class="featured-review-img-dtl">
                                        <div class="review-img-name"><span>{{ $rating->user['fname'] }} {{ $rating->user['lname'] }}</span></div>
                                        <div class="pull-left">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <tbody>
                                        <td>
                                          <ul>
                                            <li><a href="#" title="about">{{ __('frontstaticword.Created') }}: {{ $bbl->user['fname'] }} {{ $bbl->user['lname'] }} </a></li>
                                ...
                                <div class="card-body">
                                    ...
                                    <tbody>
                                        <td>
                                            <ul>
                                                <li>
                                                    <a href="#" title="about">{{ __('frontstaticword.Created') }}: {{ $meeting->user['fname'] }} {{ $meeting->user['lname'] }} </a>
                        ...
                        <div class="row">
                            <div class="col-lg-7 col-md-6 col-12">
                                <div class="row">
                                    ...
                                    <div class="col-lg-5 col-sm-5 col-7">
                            ...
                            <div class="col-lg-2 col-md-1 col-4" style="display:none;">
                            ...
                            <div class="col-lg-2 col-md-3 col-4" style="display:none;">
                                @if($item->type==1)
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-8 col-sm-8">
                                <div class="instructor-block">
                                    <div class="instructor-name btm-10"><a href="{{ route('instructor.profile', ['id' => $course->user->id, 'name' => $fullname] ) }}" title="instructor-name">{{ $course->user['fname'] }} {{ $course->user['lname'] }}</a></div>
