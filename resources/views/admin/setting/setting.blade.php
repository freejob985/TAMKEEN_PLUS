    	 ...
    	 <div class="box-body">
          ...
          <div class="nav-tabs-custom">
            <ul class="nav nav-tabs" id="nav-tab" role="tablist">
              <li role="presentation" class="active"><a href="#home" style="
    display: none;
" aria-controls="home" role="tab" data-toggle="tab"><i class="flaticon-optimization" aria-hidden="true"></i> {{ __('adminstaticword.GeneralSetting') }}</a></li>
    ...
    display: none;
"><a href="#messages" aria-controls="messages" role="tab" data-toggle="tab"><i class="flaticon-email" aria-hidden="true"></i> {{ __('adminstaticword.MailSetting') }}</a></li>
              <li role="presentation"><a href="#settings"  style="
    display: none;
" aria-controls="settings" role="tab" data-toggle="tab"><i class="flaticon-test" aria-hidden="true"></i> {{ __('adminstaticword.CustomStyleandJS') }}</a></li>
