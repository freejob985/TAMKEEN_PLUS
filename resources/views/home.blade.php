...
<section style="display:none;" id="student" class="student-main-block top-40">
    <div class="container">

        @if($total_count !== 0)
        <h4 class="student-heading wow slideInUp">اخر المشاهدات</h4>
        <div id="recent-courses-slider" class="student-view-slider-main-block owl-carousel">
            @foreach($recent_course_id as $view)
            @php

            $recent_course = App\Course::where('id', $view)->where('sort', 'admin')->first();
                    ...
                    <div class="genre-slide-image">
                        <div class="view-block wow fadeIn">
                            ...
                            <div class="view-dtl">
                                ...
                                <p class="btm-10"><a herf="#"> {{ $recent_course->user['fname'] }} {{ $recent_course->user['lname'] }}</a></p>
                                <div class="rating">
                                    <ul>
                                        <li>
                                            <?php
...
<section id="student" class="student-main-block top-40">
    <div class="container">
        ...
        @if(count($enroll) > 0)
        <h4 class="student-heading wow slideInUp">{{ __('frontstaticword.MyPurchasedCourses') }}</h4>
                    ...
                    <div class="genre-slide-image">
                        <div class="view-block wow fadeIn">
                            ...
                            <div class="view-dtl">
                                ...
                                <p class="btm-10"><a herf="#"> {{ $enrol->courses->user['fname'] }} {{ $enrol->courses->user['lname'] }}</a></p>
                                <div class="rating">
                                    <ul>
                                        <li>
                                            <?php
...
<!-- Student start -->
@php
$cors = App\Course::where('status', '1')->where('sort', 'admin')->where('featured', '1')->get();
@endphp
@if( ! $cors->isEmpty() )
<section id="student" class="student-main-block">
    <div class="container">
        <h4 class="student-heading wow slideInUp">{{ __('frontstaticword.FeaturedCourses') }}</h4>
...
<!-- Student start -->
@php
$cors = App\Course::where('status', '1')->where('sort', 'admin')->where('featured', '1')->orderBy('id', 'desc')->take(10)->get();
@endphp
@if( ! $cors->isEmpty() )

    <div class="container">
        <h4 class="student-heading wow slideInUp">أخر الاضافات</h4>
        <div id="my-courses-slider" class="student-view-slideraa-main-blockaa owl-carousel">
            @foreach($cors as $c)
              @if($c->status == 1 && $c->featured == 1)
...
<section id="subscription" class="student-main-block">
    <div class="container">
        @if (isset($subscriptionBundles) && !$subscriptionBundles->isEmpty())
            <h4 class="student-heading wow slideInUp">الباقات والعروض الخاصة</h4>
...
<section id="bundle-block" class="student-main-block">
    <div class="container">
        @if(count($bundles) > 0)
        <h4 class="student-heading wow slideInUp">{{ __('frontstaticword.BundleCourses') }}</h4>
                    ...
                    <div class="genre-slide-image @if($gsetting['course_hover'] == 1) protip @endif" data-pt-placement="outside" data-pt-interactive="false" data-pt-title="#prime-next-item-description-block-4{{$bundle->id}}">
                        <div class="view-block wow fadeIn">
                            ...
                            <div class="view-dtl">
                                ...
                                <p class="btm-10"><a herf="#"> {{ $bundle->user['fname'] }} {{ $bundle->user['lname'] }}</a></p>
...
<section id="batch-block" class="student-main-block" style="display:none;">
    <div class="container">
        @if(count($batches) > 0)
        <h4 class="student-heading wow slideInUp">دورات خاصة</h4>
                    ...
                    <div class="genre-slide-image @if($gsetting['course_hover'] == 1) protip @endif" data-pt-placement="outside" data-pt-interactive="false" data-pt-title="#prime-next-item-description-block-5{{$batch->id}}">
                        <div class="view-block wow fadeIn">
                            ...
                            <div class="view-dtl">
                                ...
                                <p class="btm-10"><a herf="#"> {{ $batch->user['fname'] }} {{ $batch->user['lname'] }}</a></p>
...
<section id="student" class="student-main-block">
    <div class="container">
        ...
        @endphp
        @if( ! $meetings->isEmpty() )
        <h4 class="student-heading wow slideInUp">{{ __('frontstaticword.ZoomMeetings') }}</h4>
                    ...
                    <div class="genre-slide-image @if($gsetting['course_hover'] == 1) protip @endif" data-pt-placement="outside" data-pt-interactive="false" data-pt-title="#prime-next-item-description-block-6{{$meeting->id}}">
                        <div class="view-block wow fadeIn">
                            ...
                            <div class="view-dtl">
                                ...
                                <p class="btm-10"><a herf="#"> {{ $meeting->user['fname'] }} {{ $meeting->user['lname'] }}</a></p>
                    ...
                    <div id="prime-next-item-description-block-6{{$meeting->id}}" class="prime-description-block">
                        <div class="prime-description-under-block">
                            <div class="prime-description-under-block">
                                ...
                                <div class="protip-img">
                                    <h3 class="description-heading"> {{ $meeting->user['fname'] }}</h>
...
<section id="student" class="student-main-block">
    <div class="container">
        ...
        @if( ! $bigblue->isEmpty() )
        <h4 class="student-heading wow slideInUp">{{ __('frontstaticword.BigBlueMeetings') }}</h4>
                    ...
                    <div class="genre-slide-image @if($gsetting['course_hover'] == 1) protip @endif" data-pt-placement="outside" data-pt-interactive="false" data-pt-title="#prime-next-item-description-block-7{{$bbl->id}}">
                        <div class="view-block wow fadeIn">
                            ...
                            <div class="view-dtl">
                                ...
                                <p class="btm-10"><a herf="#"> {{ $bbl->user['fname'] }}</a></p>
...
<section id="student" class="student-main-block" style="display:none;">
    <div class="container">
        ...
        <h4 class="student-heading wow slideInUp">المدونة</h4>
                    ...
                    <div class="genre-slide-image @if($gsetting['course_hover'] == 1) protip @endif" data-pt-placement="outside" data-pt-interactive="false" data-pt-title="#prime-next-item-description-block-8{{$blog->id}}">
                        <div class="view-block wow fadeIn">
                            ...
                            <div class="view-dtl">
                                ...
                                <p class="btm-10"><a herf="#"> {{ $blog->user['fname'] }} {{ $blog->user['lname'] }}</a></p>
...
<section id="border-recommendation" class="border-recommendation" style="display:none;">
    @php
    ...
    <div class="recommendation-main-block  text-center" style="background-image: url('{{ asset('images/getstarted/'.$gets['image']) }}')">
        <div class="container wow zoomIn">
            <h3 class="text-white text-center" style="text-align:center;">{{ $gets['heading'] }}</h3>
...
@if(isset($categories))
<section id="learning-courses" class="learning-courses-main-block" style="display:none;">
    <div class="container">
        <h4 class="student-heading wow slideInUp">{{ __('frontstaticword.RecentCourses') }}</h4>
        <div class="row">
...
<section id="categories" class="categories-main-block" style="display:none;">
    <div class="container">
...
@if( !$trusted->isEmpty() )
<section id="trusted" class="trusted-main-block" style="display:none;">
    <div class="container">
        <div class="patners-block">
            ...
            <div id="patners-slider" class="patners-slider owl-carousel">
                @foreach($trusted as $trust)
                    @if($trust->status == 1)
                    <div class="item-patners-img  wow zoomIn">
...
<style>.rating{display:none;}</style>
