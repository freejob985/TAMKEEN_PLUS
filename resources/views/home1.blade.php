    ...
    <div class="container">
        <div id="categories-tab-slider" class="categories-tab-block owl-carousel">
            ...
            @foreach($category as $cat)
                @if($cat->status == 1)
                <div class="item wow fadeInUp categories-tab-dtl">
...
<section id="about-transforming" class="about-transforming-main-block" style="display:none;">
   <div class="container">
...
<section id="student"  class="student-main-block top-40">
    <div class="container">
        ...
        @if($total_count !== 0)
        <h4 class="student-heading">اخر الجلسات التي تم مشاهدتها</h4>
        <div id="recent-courses-slider" class="student-view-slider-main-block owl-carousel">
            ...
            @if(isset($recent_course))
              ...
              @if($recent_course->status == 1 && $recent_course->featured == 1)
                <div class="item wow fadeInUp student-view-block student-view-block-1">
...
<section id="student" class="student-main-block top-40">
    <div class="container">
        ...
        @if(count($enroll) > 0)
        <h4 class="student-heading">مشترياتي من الجلسات</h4>
...
<section id="learning-courses" class="learning-courses-main-block">
    <div class="container">
        <h4 class="student-heading">اقسام الجلسات</h4>
        <div class="row">
...
<section id="student" class="student-main-block"  >
    <div class="container">
        <h4 class="student-heading">الجلسات المميزة</h4>
...
<section id="subscription" class="student-main-block" >
    <div class="container">
        @if (isset($subscriptionBundles) && !$subscriptionBundles->isEmpty())
            <h4 class="student-heading">اهم الباقات</h4>
...
<!-- Bundle start -->
@if(isset($bundles))
<section id="bundle-block" class="student-main-block" style="padding:103px 0;">
    <div class="container">
        @if(count($bundles) > 0)
        <h4 class="student-heading">عروض  خاصة</h4>
...
<section id="student" class="student-main-block" >
    <div class="container">
        ...
        <h4 class="student-heading">المدونة</h4>
...
<section id="border-recommendation" class="border-recommendation">
    ...
    <div class="recommendation-main-block  text-center" style="background-image: url('{{ asset('images/getstarted/'.$gets['image']) }}')">
        <div class="container">
            <h3 class="text-white text-center">{{ $gets['heading'] }}</h3>
    ...
    <div class="container">
        ...
        <div id="testimonial-slider" class="testimonial-slider-main-block owl-carousel">
            ...
            @foreach($testi as $tes)
             @if($tes->status == 1)
            <div class="item wow fadeInUp testimonial-block">
                <ul>
        ...
        <div class="patners-block">
            ...
            <div id="patners-slider" class="patners-slider owl-carousel">
                @foreach($trusted as $trust)
                    @if($trust->status == 1)
                    <div class="item wow fadeInUp-patners-img">
