                ...
                <div class="sidebar-nav-icon">
                    <ul>
                        ...
                        @endif
                                          ...
                                          <li><a href="http://edu.engwalaa.com/about/show">عن الموقع</a></li>
                                               
                                    
                                         <li><a href="http://edu.engwalaa.com/cat">كلمات مصورة</a></li>
                                               <li><a href="http://edu.engwalaa.com/show/careers">حاضنة الأعمال</a></li>
                                                  <li style="
   
"><a href="http://edu.engwalaa.com/all/blog">المدونة</a></li>
 <li><a href="http://edu.engwalaa.com/user_contact">التواصل</a></li>
 </ul>
                </div>
                        ...
                        <div class="navigation">
                            <div id="cssmenu">
                                <ul>
                                    ...
                                    <li ><a href="#" title="Categories">الدورات التدربية</a>
                                        @php
                                         $categories = App\Categories::orderBy('position','ASC')->get();
                                        @endphp
                                        <ul>
                                         ...
                                         <li><a href="http://edu.engwalaa.com/cat">كلمات مصورة</a></li>
                                               <li><a href="http://edu.engwalaa.com/show/careers">حاضنة الأعمال</a></li>
  <li><a href="/bundle/page">عروض مميزة</a></li>
  <li><a href="/batch/page">دورات خاصة </a></li>
  <li><a href="{{ url('browse') }}"> كل الدورات </a></li>
 </ul>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-lg-4" style="margin-top:30px;">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-2 col-md-2 col-6"  style="display:none;">
