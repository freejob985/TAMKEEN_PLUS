...
class CourseController extends Controller
{
    ...
    public function create()
    {
        ...
        if(Auth::user()->role==="instructor"){
          $category = Categories::whereIn('id', [17, 18, 19,20])->get();
        }else{
    ...
    public function DetailPage($id, $slug)
    {
      ...
      if(Auth::check())
      {
        ...
        if(!empty($bundle_check))
        {
          ...
          if(Auth::user()->role == 'user')
          {
            ...
            return view('front.detail',compact('course','courseinclude','whatlearns','coursechapters','courseclass', 'coursereviews', 'reviews', 'relatedcourse', 'course_id', 'ad', 'bigblue', 'meetings', 'order', 'wish', 'currency', 'cart', 'instruct_course'));
          }
          else
          {
            return view('front.detail',compact('course','courseinclude','whatlearns','coursechapters','courseclass', 'coursereviews', 'reviews', 'relatedcourse', 'ad', 'bigblue', 'meetings', 'order', 'wish', 'currency', 'cart', 'instruct_course'));
          }
        }
        else{
      ...
      {
        return view('front.detail',compact('course','courseinclude','whatlearns','coursechapters','courseclass', 'coursereviews', 'reviews', 'relatedcourse', 'ad', 'bigblue', 'meetings', 'currency'));
      }
