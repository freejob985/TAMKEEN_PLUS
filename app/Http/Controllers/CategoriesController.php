...
if(Auth::user()->role==="instructor"){
  $cate = Categories::orderBy('position','ASC')->whereIn('id', [17, 18, 19,20])->get();
}else{
  $cate = Categories::orderBy('position','ASC')->get();
    ...
    public function categoryPage(Request $request)
    {
        ...
        if($request->type){
          ...
          $courses = $cats->courses()->where('status', '1')->where('sort', 'admin')->where('type','=',$request->type == 'paid' ? '1' : '0')->paginate($request->limit ?? 10);
          ...
          if($request->sortby == 'l-h'){
            ...
            $courses = $cats->courses()->where('type','=','1')->where('sort', 'admin')->orderBy('price','DESC')->paginate($request->limit ?? 10);
          ...
          if($request->sortby == 'h-l'){
            ...
            $courses = $cats->courses()->where('type','=','1')->where('sort', 'admin')->orderBy('price','ASC')->paginate($request->limit ?? 10);
          ...
          if($request->sortby == 'a-z'){
            ...
            if($request->type)
            {
              $courses = $cats->courses()->where('type','=',$request->type == 'paid' ? 1 : 0)->where('sort', 'admin')->orderBy('title','ASC')->paginate($request->limit ?? 10);
            }
            else{

              $courses = $cats->courses()->orderBy('title','ASC')->where('sort', 'admin')->paginate($request->limit ?? 10);
          ...
          if($request->sortby == 'z-a'){
            ...
            if($request->type)
            {
              $courses = $cats->courses()->where('type','=',$request->type == 'paid' ? 1 : 0)->where('sort', 'admin')->orderBy('title','DESC')->paginate($request->limit ?? 10);
            }
            else{

              $courses = $cats->courses()->where('sort', 'admin')->orderBy('title','DESC')->paginate($request->limit ?? 10);
          ...
          if($request->sortby == 'newest'){
            ...
            if($request->type){
              ...
              $courses = $cats->courses()->where('sort', 'admin')->where('type','=',$request->type == 'paid' ? 1 : 0)->orderBy('created_at','DESC')->paginate($request->limit ?? 10);

              
            }else{

              $courses = $cats->courses()->where('sort', 'admin')->orderBy('created_at','DESC')->paginate($request->limit ?? 10);
          ...
          if($request->sortby == 'featured'){
            ...
            if($request->type)
            {
              $courses = $cats->courses()->where('sort', 'admin')->where('type','=',$request->type == 'paid' ? 1 : 0)->where('featured','=', '1')->paginate($request->limit ?? 10);
            }
            else{

              $courses = $cats->courses()->where('sort', 'admin')->where('featured','=', '1')->paginate($request->limit ?? 10);
          ...
          if($request->limit == '10'){
            ...
            $courses = $cats->courses()->where('sort', 'admin')->paginate(2);

          }
          elseif($request->limit == '30'){

            $courses = $cats->courses()->where('sort', 'admin')->paginate($request->limit);
          ...
          elseif($request->limit == '100'){
            ...
            $courses = $cats->courses()->where('sort', 'admin')->paginate($request->limit ?? 10);
        ...
        $filter_count = $courses->where('sort', 'admin')->count();

        
        $subcat = SubCategory::where('category_id', $cats->id)->get();
                return view('front.category',compact('cats', 'courses', 'subcat', 'filter_count', 'allcats'));

        }else{
 
                    return view('front.category',compact('courses', 'allcats'));
    ...
    public function subcategoryPage(Request $request)
    {
        ...
        if($request->type){
          ...
          if($request->sortby == 'l-h'){
            ...
            $courses = $cats->courses()->where('sort', 'admin')->where('type','=','1')->orderBy('price','DESC')->paginate($request->limit ?? 10);
          ...
          if($request->sortby == 'h-l'){
            ...
            $courses = $cats->courses()->where('sort', 'admin')->where('type','=','1')->orderBy('price','ASC')->paginate($request->limit ?? 10);
          ...
          if($request->sortby == 'a-z'){
            ...
            if($request->type)
            {
              $courses = $cats->courses()->where('sort', 'admin')->where('type','=',$request->type == 'paid' ? 1 : 0)->orderBy('title','ASC')->paginate($request->limit ?? 10);
            }
            else{

              $courses = $cats->courses()->where('sort', 'admin')->orderBy('title','ASC')->paginate($request->limit ?? 10);
          ...
          if($request->sortby == 'z-a'){
            ...
            if($request->type)
            {
              $courses = $cats->courses()->where('sort', 'admin')->where('type','=',$request->type == 'paid' ? 1 : 0)->orderBy('title','DESC')->paginate($request->limit ?? 10);
            }
            else{
