...
Route::middleware(['web'])->group(function () {
  ...
  Route::middleware(['IsInstalled' ,'switch_languages', 'ip_block'])->group(function () {
    ...
    Route::middleware(['is_verified', 'maintanance_mode'])->group(function () {
        ...
        Route::get('/bundle/page', 'HomeController@bundle');
        Route::get('/batch/page', 'HomeController@batch');

        Route::get('/cat', 'HomeController@index_');
    ...
    Route::middleware(['is_active', 'auth', 'maintanance_mode'])->group(function () {
        ...
        Route::middleware(['is_admin'])->group(function () {
            ...
            Route::put('frontslider/update/upd', 'CategorySliderController@upd');
    ...
    Route::middleware(['is_verified'])->group(function () {
        ...
        Route::get('/course/{id}/Instructor/{slug}','CourseController@DetailPage')->name('Instructor.course.show');
        ...
        Route::get('tabcontent/instructor/{id}','TabController@sh');
